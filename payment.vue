          ...
          <ul class="list-group mb-3">
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div>
                ...
                <small class="text-muted">n*class_fare</small>
              </div>
              <span class="text-muted">total_class</span>
            </li>
            <li class="list-group-item d-flex justify-content-between lh-condensed">
              <div>
                <h6 class="my-0">Add On's</h6>
              </div>
              <span class="text-muted">total_addons</span>
            </li>
            <li class="list-group-item d-flex justify-content-between">
              <span>Total</span>
              <strong>total_class+total_addons</strong>
            </li>
          </ul>
